...
namespace NavPal
{
    ...
    public static class EncounterSpotBuilder
    {
        ...
        /// path - that is, beside you rather than ahead or behind. Valve's comment explains the intent:
        /// these are the spots that become visible as you walk past them, which is the moment worth
        /// warning a bot about. Something dead ahead was already in view before the move started.
        /// </summary>
